...
export declare type InteractiveListItem = InteractiveListItemObject | string;
...
export declare const enum InteractiveListBorderType {
    none = 0,
    normal = 1,
    focus = 2,
    error = 3
}
export declare enum InteractiveListDirection {
    normal = 0,
    reverse = 1
}
