...
export declare type BasicPosition = 'top' | 'right' | 'bottom' | 'left';
export declare type TooltipPosition = BasicPosition | 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right' | 'right-top' | 'right-bottom' | 'left-top' | 'left-bottom';
