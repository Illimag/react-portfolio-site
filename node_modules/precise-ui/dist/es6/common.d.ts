...
export declare type PreciseThemeColors = {
    /**
     * Theme color UI0.
     */
    ui0: string;
...
export declare type PreciseTheme = {
    [T in keyof PreciseFullTheme]?: Partial<PreciseFullTheme[T]>;
};
...
export declare const ScreenSizeList: ("small" | "medium" | "large" | "xLarge" | "max")[];
export declare type ScreenSize = typeof ScreenSizeList[number];
export declare type KeyofBase = keyof any;
export declare type Diff<T extends KeyofBase, U extends KeyofBase> = ({
    [P in T]: P;
} & {
    [P in U]: never;
} & {
...
export declare type Component<P> = React.ComponentClass<P> | React.StatelessComponent<P>;
