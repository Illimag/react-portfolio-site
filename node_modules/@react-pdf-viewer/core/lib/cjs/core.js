...
var Viewer = function (_a) {
    ...
    var _o = React__namespace.useState(localization), l10n = _o[0], setL10n = _o[1];
    var localizationContext = { l10n: l10n, setL10n: setL10n };
    var themeContext = withTheme(theme, onSwitchTheme);
    React__namespace.useEffect(function () {
    ...
    return (React__namespace.createElement(LocalizationContext.Provider, { value: localizationContext },
        React__namespace.createElement(ThemeContext.Provider, { value: themeContext },
            React__namespace.createElement("div", { ref: containerRef, className: "rpv-core__viewer rpv-core__viewer--" + themeContext.currentTheme, "data-testid": "viewer", style: {
                    height: '100%',
                    width: '100%',
