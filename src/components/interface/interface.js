...
<div>
            ...
            <div>
             <FigmaEmbed className={styles.testfigmaprototype} url="https://www.figma.com/file/aWwYlf9g7PJw6ME8l1vcwH/ASP-Web-App" />
            </div>


            <div>
             <FigmaEmbed className={styles.testfigmaprototype} url="https://www.figma.com/file/UPhtcXdOEosNTClAf9o2kR/Untitled" />
            </div>

            <div>
             <FigmaEmbed className={styles.testfigmaprototype} url="https://www.figma.com/file/n2P2lCIAdASvEZbCXT2ZSe/MFA-Landing-Page-Final-Designs" />
            </div>
            
            <div>
             <FigmaEmbed className={styles.testfigmaprototype} url="https://www.figma.com/proto/Gj1z4k4K9KSgnycfJPxsjI/MFA-News-Hopper?page-id=0%3A1&node-id=2%3A82&viewport=-140%2C557%2C0.25&scaling=scale-down" />
            </div>


            <div>
             <FigmaEmbed className={styles.testfigmaprototype} url="https://www.figma.com/proto/xFnRvQKpME3AKtC3h6uieK/BUS-APP-WIREFRAMES" />
            </div>

            <div>
             <FigmaEmbed className={styles.testfigmaprototype} url="https://www.figma.com/file/tyxM1cDdtDrxFVhUKb2gbQ/Bus-App-Wire-Frames" />
            </div>
